...
def main() -> None:
    try:
        ...
        # Filtro de nomes e data para citações
        with tabs[0]:
            ...
            # Visualização e análise de dados após o filtro aplicado...

        # Filtro de nomes e data para intimações
        with tabs[1]:
