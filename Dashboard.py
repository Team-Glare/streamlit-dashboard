...
def main() -> None:
    try:
        if not host or not user or not database:
            st.error(
                "Erro! Faltam informações de conexão com o banco de dados."
            )
            return
        ...
        intimacoes_dados = intimacoes_dados[
            intimacoes_dados["name"].isin(names)
        ]
            ...
            if "datapub" in dados.columns:
                ...
                bar = (
                    ...
                    .add_yaxis(
                        ...
                        publicacoes_mensais.groupby("mes_ano")["quantidade"]
                        .sum()
                        .tolist(),
                    )
                    .set_global_opts(
