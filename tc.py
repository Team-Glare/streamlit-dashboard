...
# Título da página
st.title("Estatística - Tribunal de Contas - TC - 2024 :bar_chart:")
...
# Informações de conexão com o banco de dados
host = "193.203.175.53"
user = "u404019115_BKpwM"
password = "EroPHP2024"
database = "u404019115_5fGc8"
...
def main() -> None:
    ...
    try:
        ...
        cursor.execute(
            "SELECT * FROM ANDAMENTOS WHERE nome_procuradoria='TC'",
        )
